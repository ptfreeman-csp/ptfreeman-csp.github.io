...
map.getView().fit([-13177461.843078, 5109246.324138, -13057908.561904, 5188245.444978], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Critical Minerals and Indicators of Conservation Value in the McDermitt Caldera</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (330 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map displays a collection of layers meant to foster exploration and discussion among interested parties about the potential impacts of critical mineral development in the McDermitt Caldera region on local dimensions of biodiversity. Individual layers can be toggled on and off using the panel in the upper right-hand corner. ';
            }
